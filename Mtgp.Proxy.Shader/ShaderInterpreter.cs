                ...
                case ShaderOp.Variable:
                    {
                        ...
                        switch (variableType.StorageClass)
                        {
                            ...
                            case ShaderStorageClass.PushConstant:
                                ...
                                {
                                    throw new InvalidOperationException("Push constant pointer has no binding decoration");
                                }
                                break;
                            default:
                            ...
                            case ShaderStorageClass.PushConstant:
                                {
                                    ...
                                    var pushConstantSpan = pushConstants[(int)uniformPointer.Pointer..][..valueType.Size];

                                    pushConstantSpan.CopyTo(targetSpan);
                                    break;
                                }
                            default:
                ...
                case ShaderOp.AccessChain:
                    {
                        ...
                        if (basePointerType.StorageClass is ShaderStorageClass.UniformConstant or ShaderStorageClass.Uniform or ShaderStorageClass.PushConstant)
                        {
